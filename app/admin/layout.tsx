...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: 'Team / Staff', href: '/admin/staff', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    { name: 'Support Inbox', href: '/admin/support', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    ...
    { name: 'Billing & Payments', href: '/admin/billing', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
    ...
    if (name.toUpperCase() === 'HIGHVANCE') {
      return (
        <span className="text-xl font-extrabold tracking-tight uppercase">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">VANCE</span>
        </span>
      );
    }
    return (
...
export default function AdminLayoutWrapper({ children }: { children: React.ReactNode }) {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center"><div className="animate-spin h-8 w-8 text-blue-600 rounded-full border-4 border-solid border-current border-r-transparent"></div></div>}>
